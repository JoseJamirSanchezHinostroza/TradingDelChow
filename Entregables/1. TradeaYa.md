...
● Propiedad de Activos: El usuario sólo podrá vender acciones que existan previamente en su portafolio y en cantidades iguales o menores a las que posee.
...
● Sánchez José(Logic y Frontend): Se encargará de la lógica central de la aplicación. Traducirá las reglas del negocio en código y creará algoritmos matemáticos que calculen comisiones, validen saldos y gestionen el portafolio ficticio del usuario de forma precisa. Además, renderizará todo el proyecto como interfaz de usuario.
