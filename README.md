...
### Además, implementamos Yahoo Finance API, cuya función es proporcionar datos históricos de dichas acciones. Así, el usuario obtiene la experiencia completa: analiza el comportamiento histórico de las acciones, revisa el precio actual de la acción de su interés y compra/vende utilizando dinero ficticio.
