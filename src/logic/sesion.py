...
class SesionTrading:
    ...
    def comprar(self, simbolo, cantidad, precio_actual, timestamp_precio):
        """
        ...
        if exito:
            ...
            self._registrar_en_historial("COMPRA", simbolo, cantidad, precio_compra)
    ...
    def vender(self, simbolo, cantidad, precio_actual, timestamp_precio):
        """
        ...
        if exito:
            ...
            self._registrar_en_historial("VENTA", simbolo, cantidad, precio_actual)
